...
export function initWWMap(mapId, riversListId, options) {
    ...
    return ymaps.ready()
        ...
        .then(_ => ymaps.modules.require(['overlay.BiPlacemark', 'overlay.RiverTrack']))
        .spread((BiPlacemrakOverlay, RiverTrackOverlay) => {
            ymaps.overlay.storage.add("BiPlacemrakOverlay", BiPlacemrakOverlay);
