...
export const LAST_POS_KEY = "last-map-pos";
export const LAST_ZOOM_KEY = "last-map-zoom";
export const LAST_MAP_TYPE_KEY = "last-map-type";
export const LAST_TOGGLES_KEY = "last-toggles";
