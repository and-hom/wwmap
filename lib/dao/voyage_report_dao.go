...
func (this VoyageReportStorage) UpsertVoyageReports(reports ...VoyageReport) ([]VoyageReport, error) {
	...
	ids, err := this.updateReturningId("INSERT INTO voyage_report(title, remote_id,source,url,date_published,date_modified,date_of_trip) " +
		"VALUES ($1, $2, $3, $4, $5, $6, $7) " +
		"ON CONFLICT (source, remote_id) DO UPDATE SET title=$1, url=$4, date_modified=$6, date_of_trip=$7 " +
		"RETURNING id",
		func(entity interface{}) ([]interface{}, error) {
			_report := entity.(VoyageReport)
			return []interface{}{_report.Title, _report.RemoteId, _report.Source, _report.Url, _report.DatePublished, _report.DateModified, _report.DateOfTrip}, nil
		}, reports_i...)
