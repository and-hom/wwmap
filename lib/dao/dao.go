...
type RiverDao interface {
	...
	FindByTitlePart(tPart string, regionId int64, countryId int64, limit, offset int) ([]RiverTitle, error)
...
type WhiteWaterDao interface {
	...
	FindByTitlePart(tPart string, regionId int64, countryId int64, limit, offset int) ([]WhiteWaterPointWithRiverTitle, error)
