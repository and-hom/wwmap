    ...
    <div>
        <btn-bar logObjectType="RIVER" :logObjectId="river.id">
            <button type="button" class="btn btn-success" v-if="pageMode == 'batch-edit'"
                    v-on:click="saveSpotsBatch()">Сохранить
            </button>
            <slot></slot>
        </btn-bar>
        <div class="spot-editor-panel" style="padding-top:15px;">
            <div v-if="canEdit && river.id">
                <div style="margin-bottom: 20px">Изменения вступят в силу после нажатия кнопки <b>Сохранить</b> выше
                </div>
                ...
                <button type="button" class="btn btn-success" v-on:click="addEmptySpotToBatch()">Добавить в конец
                </button>
                <div>
                          ...
                          return x!=spot.id;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-10"><textarea rows="10" cols="120"
                                                                  v-model="spot.approach"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <hr/>
                                <div class="row">
                                    <div class="col-12"><strong>Другие варианты названия для поиска
                                        изображений:</strong>
